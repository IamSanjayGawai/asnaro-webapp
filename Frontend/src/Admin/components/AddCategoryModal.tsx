...
import { createParentCategoryThunk } from "@/state/thunks/adminThunks";
import { useAppDispatch } from "@/state/hooks";

interface DataProps {
  showCategoryModal: boolean;
  setShowCategoryModal?: (showModal: boolean) => void;
  show?: boolean;
...
const Modal = ({
  ...
  const handleCreate = () => {
    dispatch(createParentCategoryThunk({ category_name: parentCategory }));
  };
