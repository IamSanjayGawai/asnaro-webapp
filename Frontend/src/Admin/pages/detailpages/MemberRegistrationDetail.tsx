...
const MemberRegistrationDetail: React.FC = () => {
  const navigate = useNavigate();
  const dispatch = useAppDispatch();
  const { other, appErr, loading } = useAppSelector(selectAdmin);
  ...
  const [dropZoneProfilePic, setDropZoneProfilePic] =
    React.useState<boolean>(false);
  const [dropZoneImg1, setDropZoneImg1] = React.useState<boolean>(false);
  const [dropZoneImg2, setDropZoneImg2] = React.useState<boolean>(false);
  const [dropZoneImg3, setDropZoneImg3] = React.useState<boolean>(false);
  ...
  const [prevCorporateAccountHolder, setPrevCorporateAccountHolder] =
    React.useState<boolean>(true);
  const [prevMemberVerification, setPrevMemberVerification] =
    React.useState<boolean>(true);
  ...
  React.useEffect(() => {
    dispatch(getUserByIdforAdminThunk(uid));
  }, []);
  ...
  React.useEffect(() => {
    if (other?.message === "Admin-User updated successfully") {
      dispatch(getUserByIdforAdminThunk(uid));
      setPrevName(true);
      setPrevKana(true);
      ...
      setPrevMemberVerification(true);
    }
  }, [other]);
  ...
  React.useEffect(() => {
    ...
    if (other?.user?.isVerified && prevMemberVerification) {
      setValue("member_verification", other.user.isVerified ? "1" : "0");
    }
  }, [
    other,
    prevName,
  ...
  const onSubmit: SubmitHandler<MemberRegForm> = async (data) => {
      ...
      if (
        ...
        switch (key) {
          ...
          case "member_verification":
            formData.append(
              "isVerified",
              newData[key] === "1" ? true : (false as unknown as any)
            );
            break;
          default:
    ...
    profilePic
      ...
      : formData.append(
          "no_profile_img",
          prevProfilePic || dropZoneProfilePic ? "false" : "true"
        );
    img1File
      ? formData.append("img1", img1File)
      : formData.append("no_img1", prevImg1 || dropZoneImg1 ? "false" : "true");
    img2File
      ? formData.append("img2", img2File)
      : formData.append("no_img2", prevImg2 || dropZoneImg2 ? "false" : "true");
    img3File
      ? formData.append("img3", img3File)
      : formData.append("no_img3", prevImg3 || dropZoneImg3 ? "false" : "true");
    ...
    await dispatch(updateUserByIdforAdminThunk({ uid, formData }));
  ...
  console.log("prevProfilePic", prevProfilePic);
  console.log("dropZoneProfilePic", dropZoneProfilePic);
  console.log("prevImg1", prevImg1);
  console.log("dropZoneImg1", dropZoneImg1);
  console.log("prevImg2", prevImg2);
  console.log("dropZoneImg2", dropZoneImg2);
  console.log("prevImg3", prevImg3);
  console.log("dropZoneImg3", dropZoneImg3);
                ...
                <div className="grid grid-cols-12 gap-y-3 gap-x-5">
                  ...
                  <div className="grid grid-cols-24 xs:col-span-12 xs:gap-y-2 md:col-span-6">
                    <div className="flex items-center xs:col-span-24 md:col-span-6">
                      <label>
                        企業名 <span className="text-fifth ml-7">※</span>
                      </label>
                    </div>
                  ...
                  <div className="grid grid-cols-24 xs:col-span-12 xs:gap-y-2 md:col-span-6">
                    <div className="flex items-center xs:col-span-24 md:col-span-10">
                      <label>
                        会社名(フリガナ){" "}
                        <span className="text-fifth ml-2">※</span>
                      </label>
                    </div>
                  ...
                  <div className="grid grid-cols-24 xs:col-span-12 xs:gap-y-2 md:col-span-6">
                    <div className="flex items-center xs:col-span-24 md:col-span-6">
                      <label>
                        代表者名 <span className="text-fifth ml-4 ">※</span>
                      </label>
                    </div>
                  ...
                  <div className="grid grid-cols-24 xs:col-span-12 xs:gap-y-2 md:col-span-6">
                    ...
                    <div className="grid grid-cols-12 xs:gap-x-1 md:gap-x-2 xs:col-span-24 md:col-span-14">
                      ...
                      {(errors.delegate_kana01 || errors.delegate_kana02) && (
                        <p className="text-fifth col-span-12">
                          入力必須項目です
                        </p>
                      )}
                    </div>
                  ...
                  <div className="grid grid-cols-24 xs:col-span-12 xs:gap-y-2 md:col-span-6">
                    <div className="flex items-center xs:col-span-24 md:col-span-6">
                      <label>
                        担当者名 <span className="text-fifth ml-4">※</span>
                      </label>
                    </div>
                    <div className="grid grid-cols-12 xs:gap-x-1 md:gap-x-2 xs:col-span-24 md:col-span-18">
                      <div className="col-span-6">
                      ...
                      >
                        {prevProfilePic && other?.user?.profile_img ? (
                          ...
                          <Dropzone
                            ...
                            isProcess={true}
                            setDropZoneImg={setDropZoneProfilePic}
                          />
                        )}
                        {prevProfilePic && other?.user?.profile_img && (
                          <svg
                            ...
                            onClick={() => {
                              setPrevProfilePic(false);
                              setDropZoneProfilePic(false);
                            }}
                          >
                            <circle
                              cx="10"
                      ...
                      <div className="bg-[#F8F8F8] relative cursor-pointer col-span-4 flex justify-center items-center xs:h-[116px] md:h-[150px] border border-[#E6E6E6]">
                        {prevImg1 && other?.user?.img1 ? (
                          ...
                          <Dropzone
                            ...
                            isReset={isReset}
                            {...register("img1")}
                            setDropZoneImg={setDropZoneImg1}
                          />
                        )}
                        {prevImg1 && other?.user?.img1 && (
                          <svg
                      ...
                      <div className="bg-[#F8F8F8] cursor-pointer relative col-span-4 w-full flex justify-center items-center xs:h-[116px]150:h-[208px] border border-[#E6E6E6]">
                        {prevImg2 && other?.user?.img2 ? (
                          ...
                          <Dropzone
                            ...
                            isReset={isReset}
                            {...register("img2")}
                            setDropZoneImg={setDropZoneImg2}
                          />
                        )}
                        {prevImg2 && other?.user?.img2 && (
                          <svg
                      ...
                      <div className="bg-[#F8F8F8] cursor-pointer relative col-span-4 w-full flex justify-center items-center xs:h-[116px]150:h-[208px] border border-[#E6E6E6]">
                        {prevImg3 && other?.user?.img3 ? (
                          ...
                          <Dropzone
                            ...
                            isReset={isReset}
                            {...register("img3")}
                            setDropZoneImg={setDropZoneImg3}
                          />
                        )}
                        {prevImg3 && other?.user?.img3 && (
                          <svg
                  ...
                  <div className="grid grid-cols-24 gap-x-3 gap-y-2 col-span-12">
                    <div className="xs:flex xs:flex-col xs:items-center md:block xs:col-span-24 md:col-span-4">
                      <label>
                  ...
                  <div className="grid grid-cols-24 xs:xs:gap-x-1 md:gap-x-2 xs:gap-y-2 col-span-12">
                    <div className="xs:flex xs:flex-col xs:items-center md:block xs:col-span-24 md:col-span-3">
                      <label>
                  ...
                  <div className="grid grid-cols-24 gap-y-2 col-span-12 xs:gap-y-3">
                    <div className="flex items-center xs:col-span-24 md:col-span-4">
                      <label>
                        所在地 <span className="text-fifth ml-7">※</span>
                      </label>
                    </div>
                    ...
                    <div className="grid grid-cols-24 col-span-24">
                      ...
                      <div className="grid grid-cols-24 md:gap-x-4 xs:gap-x-0 xs:col-span-24 md:col-span-17">
                        <div
                          className="flex items-center xs:col-span-24 md:col-span-5"
                          style={{ marginLeft: "-135px" }}
                        >
                          <label>番地・建物名</label>
                        </div>
                        <div
                          className="xs:col-span-24 md:col-span-19"
                  ...
                  <div className="grid grid-cols-24 col-span-12 xs:gap-y-2 md:gap-y-">
                    <div className="flex items-center xs:col-span-24 md:col-span-8">
                      <label>
                        管理者メールアドレス{" "}
                        <span className="text-fifth ml-14">※</span>
                      </label>
                    </div>
                  ...
                  <div className="grid grid-cols-24 col-span-12 xs:gap-y-2 md:gap-y-">
                    <div className="flex items-center xs:col-span-24 md:col-span-8">
                      <label>
                        管理者メールアドレス(確認用){" "}
                        <span className="text-fifth ml-1">※</span>
                      </label>
                    </div>
                    <div className="flex flex-col xs:col-span-24 md:col-span-13">
                      <input
                  ...
                  <div className="grid grid-cols-24 col-span-12 xs:gap-y-2 md:gap-y-">
                    ...
                    <div className="xs:col-span-24 md:col-span-15 ml-16">
                      <input
                        className={`h-[36px] w-full outline-none border ${
                  ...
                  <div className="grid grid-cols-24 col-span-12 xs:gap-y-2 md:gap-y-">
                    ...
                    <div className="ml-4 col-span-4 flex items-center">
                      万円
                    </div>
                  </div>
                  <div className="grid grid-cols-24 col-span-12 xs:gap-y-2 md:gap-y-">
                  ...
                  <div className="grid grid-cols-24 gap-y-3 col-span-12">
                    <div className="flex items-center xs:col-span-24 md:col-span-3">
                      <label>
                        定休日 <span className="text-fifth ml-4">※</span>
                      </label>
                    </div>
                      ...
                      <div className="xs:col-span-24 md:col-span-18">
                        <input
                          ...
                          {...register("corporate_account_number", {
                            onChange: () =>
                              setPrevCorporateAccountNumber(false),
                          })}
                      ...
                      <div className="xs:col-span-24 md:col-span-18">
                        <input
                          ...
                          {...register("corporate_account_holder", {
                            onChange: () =>
                              setPrevCorporateAccountHolder(false),
                          })}
                        ...
                        <div className="grid grid-cols-24 col-span-10">
                          <div className="flex items-center col-span-5">
                            <input
                              ...
                              onClick={() => {
                                setPrevMemberVerification(false);
                                setIsVerified(true);
                              }}
                              {...register("member_verification", {
                                required: "このフィールドは必須です",
                              })}
                              checked={
                                prevMemberVerification
                  ...
                  <div className="flex justify-around items-center h-[45px] col-span-12 text-white mb-[240px]">
                    <button
                      className="h-full bg-[#808080] xs:w-[40%] lg:w-[40%] "
                      onClick={() =>
                        navigate("/admin/dashboard/company-information")
                      }
                    >
                      戻る
                    </button>
                    <button
                      type="submit"
                      className="h-full bg-fourth xs:w-[40%] lg:w-[40%]"
...
export default MemberRegistrationDetail;
